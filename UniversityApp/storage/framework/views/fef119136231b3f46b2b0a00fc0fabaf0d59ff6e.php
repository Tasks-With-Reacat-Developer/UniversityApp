...
<div class="container">
 ...
 <div class="card">	
<div class="card-header"><?php echo e(__('Create Lectures Schedule')); ?></div>
   <?php echo Form::open(['action'=> 'Admin\AdminSchedulesController@storeLec','method' => 'POST']); ?>
 ...
 <?php for($i=0; $i<4; $i++): ?>
    ...
    <select name="seclec[]" id="seclec" class="form-control">
      ...
      <td>
    <?php echo e(Form::text('proinc[]','',['class' => 'form-control', 'placeholder' => 'Professor/Instructor'])); ?>

     </td>
     <td>
    <?php echo e(Form::text('time_from[]','',['class' => 'form-control', 'placeholder' => 'Time From'])); ?>

    </td>
    <td>
    <?php echo e(Form::text('time_to[]','',['class' => 'form-control', 'placeholder' => 'Time To'])); ?>
    ...
    <a href="#" onclick="removeCourse()">&nbsp;&nbsp;&nbsp;Remove Course</a>
	  ...
	  <?php echo e(Form::submit('Submit',['name' => 'save','class' => 'btn btn-primary'])); ?>
...
$('#courses'+i).append($('<option>', {value:courses[x]["id"], text:courses[x]["course_name"]}));
}
...
<?php echo $__env->make('admin.lang.en.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversityApp\resources\views/admin/lang/en/schedules/create_lecture_schedule.blade.php ENDPATH**/ ?>