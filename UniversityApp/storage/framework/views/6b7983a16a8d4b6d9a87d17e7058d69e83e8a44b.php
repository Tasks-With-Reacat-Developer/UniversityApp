...
<div class="container">
    <div class="row justify-content-center">
	 <div class="col-lg-12">
 <h2 class="heading-ltr">Create Exam Schedule</h2>
 <div class="card">	
<div class="card-header"><?php echo e(__('Create Exam Schedule')); ?></div>
   <?php echo Form::open(['action'=> 'Admin\AdminSchedulesController@storeExam','method' => 'POST']); ?>
...
<?php echo $__env->make('admin.lang.en.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversityApp\resources\views/admin/lang/en/schedules/create_exam_schedule.blade.php ENDPATH**/ ?>