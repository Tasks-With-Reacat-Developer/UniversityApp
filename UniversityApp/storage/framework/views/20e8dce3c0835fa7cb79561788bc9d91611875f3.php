 ...
 $counts = 0;
  ...
  <thead>
    <tr>
      ...
      <th scope="col"><?php echo e($times[$i]); ?> إلي <?php echo e($exam_sh->time_to); ?></th>
      <?php break; ?>
      <?php endif; ?>
...
<?php echo $__env->make('lang.ar.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversityApp\resources\views/lang/ar/student/exam_schedule.blade.php ENDPATH**/ ?>