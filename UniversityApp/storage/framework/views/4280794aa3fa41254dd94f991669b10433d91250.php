...
<div class="container">
 ...
 <div class="card">	
<div class="card-header"><?php echo e(__('Add Student Data')); ?></div>
   <table>
    <tr>
   <td>&nbsp;Student Name:&nbsp;</td>
   ...
   <?php echo Form::open(['action'=> ['Admin\AdminStudentsController@store_student_data', $student->id ],'method' => 'POST']); ?>
   ...
   <th>Grade</th>
    ...
    <tr>
    <td>
    <select name="course[]" id="course<?php echo e($i); ?>" class="form-control">
     <option value="">Select Course</option>
     </option>
     </select>
     </td>
    <td>
    <?php echo e(Form::number('mid_term_grade[]','',['class' => 'form-control', 'placeholder' => 'Mid-Term Grade'])); ?>

    </td>
    <td>
     <select name="grade[]" id="grade<?php echo e($i); ?>" class="form-control">
    ...
    <a href="#" onclick="removeCourse()">&nbsp;&nbsp;&nbsp;Remove Course</a>
				...
				<?php echo e(Form::submit('Save',['name' => 'save','class' => 'btn btn-primary'])); ?>
...
<?php echo $__env->make('admin.lang.en.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\UniversityApp\resources\views/admin/lang/en/students/students_data/create.blade.php ENDPATH**/ ?>