...
<div class="card-body">
 <div class="row">  
     <div class="col-sm-13">
         <h1 style="text-align: right; color: #10ADB2;">{{$dean_ar->title}}</h1>
...
<div class="card" style="width: 18rem; height:21.3rem">
  ...
  <div class="card-body">
    ...
    <p class="card-text" style="text-align: center">{{$message_ar->content}}</p>
...
<div class="card" style="width: 18rem; height:21.3rem">
 <center>
  ...
  <div class="card-body">
    ...
    <p class="card-text" style="text-align: center">{{$future_vision_ar->content}}</p>
