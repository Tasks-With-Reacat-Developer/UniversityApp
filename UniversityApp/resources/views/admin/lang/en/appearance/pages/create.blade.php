...
<div class="card-header">{{ __('Add Page') }}</div>
   {!! Form::open(['action'=> 'Admin\AdminAppearanceController@storePage' ,'method' => 'POST']) !!}
        <div class="selects">
        <table>
        <tr>
        <td>&nbsp;Language:&nbsp;</td>
   ...
   <th>Page Link</th>
    ...
    <tr>
    <td>
    {{Form::text('page_title','',['class' => 'form-control', 'placeholder' => 'Page Title'])}}
    </td>
    <td>
    {{Form::text('page_link','',['class' => 'form-control', 'placeholder' => 'Page Link'])}}
      </td>
     </tr>
     <tbody class="pages">
     </tbody>
